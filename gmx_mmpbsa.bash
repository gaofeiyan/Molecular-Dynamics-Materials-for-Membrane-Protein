...
trj=analyze.xtc		# 轨迹文件 trajectory file
tpr=md.tpr		# tpr文件  tpr file
ndx=prolig_center.ndx		# 索引文件 index file

pro=Protein			# 蛋白索引组   index group name of protein
lig=UNK			# 配体索引组   index group name of ligand
...
apbs='/usr/bin/apbs'				# APBS(Windows), USE "/", NOT "\"
